...
public class TelaCadastrarPerguntaProfessor extends JFrame {
    ...
    public TelaCadastrarPerguntaProfessor() {
        ...
        RoundedTextField tfAlt1 = new RoundedTextField(20); tfAlt1.setFont(fieldFont); tfAlt1.setPlaceholder("Alternativa 1");
        RoundedTextField tfAlt2 = new RoundedTextField(20); tfAlt2.setFont(fieldFont); tfAlt2.setPlaceholder("Alternativa 2");
        RoundedTextField tfAlt3 = new RoundedTextField(20); tfAlt3.setFont(fieldFont); tfAlt3.setPlaceholder("Alternativa 3");
        RoundedTextField tfAlt4 = new RoundedTextField(20); tfAlt4.setFont(fieldFont); tfAlt4.setPlaceholder("Alternativa 4");
        ...
        GridBagConstraints gbc = new GridBagConstraints(); gbc.fill=GridBagConstraints.HORIZONTAL; gbc.anchor=GridBagConstraints.CENTER;

        gbc.gridy=0; gbc.gridwidth=2; gbc.insets=new Insets(0,0,20,0); content.add(IconUtils.getAppIconLabel(),gbc);
        JLabel title=new JLabel("Cadastrar - Pergunta",SwingConstants.CENTER); title.setFont(headerFont);
        gbc.gridy=1; gbc.insets=new Insets(0,0,20,0); content.add(title,gbc);

        gbc.gridy=2; gbc.gridwidth=2; gbc.insets=new Insets(10,0,5,0); content.add(lblPergunta,gbc);
        gbc.gridy=3; gbc.insets=new Insets(0,0,20,0); content.add(tfPergunta,gbc);

        gbc.gridy=4; content.add(cbDificuldade,gbc);

        gbc.gridwidth=1;
        gbc.gridy=5; gbc.gridx=0; gbc.insets=new Insets(0,0,10,-70); content.add(tfAlt1,gbc);
        gbc.gridx=1; gbc.insets=new Insets(0,105,10,0); content.add(tfAlt2,gbc);
        gbc.gridy=6; gbc.gridx=0; gbc.insets=new Insets(0,0,20,-70); content.add(tfAlt3,gbc);
        gbc.gridx=1; gbc.insets=new Insets(0,105,20,0); content.add(tfAlt4,gbc);

        gbc.gridwidth=2; gbc.gridx=0; gbc.gridy=7; gbc.insets=new Insets(0,75,10,75); content.add(btnCadastrar,gbc);
        gbc.gridy=8; content.add(btnVoltar,gbc);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(TelaCadastrarPerguntaProfessor::new);
    }
}