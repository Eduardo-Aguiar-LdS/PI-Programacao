...
public class TelaCadastrarAlunoProfessor extends JFrame {
    ...
    public TelaCadastrarAlunoProfessor(Professor professor, Coordenador coordenador) throws Exception {
        ...
        lblTurma.setFont(textFont);
        gbc.gridx = 1;
        JLabel lblAluno = new JLabel("Aluno");
        lblAluno.setFont(textFont);
        ...
        btnCadastrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    dao.setNomeTurma(turmaSelecionada);
                    Aluno aluno = new Aluno(tfAluno.getText(), tfEmail.getText(), tfSenha.getText(), turmaSelecionada);
                    professor.cadastrarAluno(aluno);
                } catch (Exception e1) {
                    e1.printStackTrace();
                }
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            try {
                new TelaCadastrarAlunoProfessor(null, null);
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
