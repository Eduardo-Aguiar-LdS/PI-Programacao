...
import telas.telas_professor.TelaEditarAlunoProfessor;
import telas.telas_professor.TelaEditarPerguntaProfessor;
...
public class TelaEditarDoAdm extends JFrame {
    ...
    public TelaEditarDoAdm(Coordenador coordenador) {
        super("Editar");
        ...
        btnAlunos.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    new TelaEditarAlunoProfessor(null, coordenador).setVisible(true);
                } catch (Exception e1) {
                    e1.printStackTrace();
                }
            }
        ...
        btnProfessores.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    new TelaEditarProfessor(coordenador).setVisible(true);
                } catch (Exception e1) {
                    e1.printStackTrace();
                }
            }
        ...
        btnPerguntas.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ((JFrame) SwingUtilities.getWindowAncestor(btnAlunos)).dispose();
                try {
                    new TelaEditarPerguntaProfessor(null, coordenador).setVisible(true);
                } catch (Exception e1) {
                    e1.printStackTrace();
                }
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            TelaEditarDoAdm frame = new TelaEditarDoAdm(null);
